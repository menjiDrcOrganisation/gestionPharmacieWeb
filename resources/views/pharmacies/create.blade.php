<el-dialog>
    <dialog id="dialog" aria-labelledby="dialog-title"
        ...
        <div tabindex="0"
            ...
            <el-dialog-panel
                class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg data-[closed]:translate-y-4 data-[closed]:opacity-0 sm:data-[closed]:translate-y-0 sm:data-[closed]:scale-95">
                ...
                <form action="{{ route('pharmacies.store') }}" method="POST"
                    ...
                    <!-- Indice -->
                    <div>
                        <label class="block text-sm font-medium text-gray-800">Indice</label>
                    ...
                    <!-- Gérant -->
                    <div class="sm:col-span-2">
                        <label class="block text-sm font-medium text-gray-800">Gérant</label>
