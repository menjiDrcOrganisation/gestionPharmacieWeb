    ...
    <div class="grid grid-cols-1 md:grid-cols-1 gap-6 mt-6">
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-2xl p-6">
            <div class="flex justify-between items-center mb-4">
                <h4 class="font-semibold dark:text-white">Admins</h4>
                <button command="show-modal" commandfor="add-admin-dialog"
                    class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500">➕ Ajouter</button>
            </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-2xl p-6">
            <div class="flex justify-between items-center mb-4">
                <h4 class="font-semibold dark:text-white">Pharmacies</h4>
                <button command="show-modal" commandfor="add-pharmacy-dialog"
                    class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500">➕ Ajouter</button>
            </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-2xl p-6">
            <div class="flex justify-between items-center mb-4">
                <h4 class="font-semibold dark:text-white">Médicaments</h4>
                <button command="show-modal" commandfor="add-medicament-dialog"
                    class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500">➕ Ajouter</button>
            </div>
            {{-- @include('medicaments.table') --}}
        </div>
