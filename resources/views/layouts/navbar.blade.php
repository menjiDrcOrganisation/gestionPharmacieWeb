                ...
                <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                    <nav>
                        ...
                        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                            ...
                            {{-- <li class="text-sm pl-2 capitalize leading-normal text-dark before:float-left before:pr-2 before:text-white before:content-['/']"
                                aria-current="page">Dashboard</li> --}}
                        </ol>
                        <h6 class="mb-0 font-bold text-dark capitalize">@yield('title')</h6>
                    </nav>
